...
typedef struct {
	uint8_t PicWidth;    /*!< Picture width in pixels */
	uint8_t PicHeight;   /*!< Picture height in pixels */
	const uint16_t *data; /*!< Pointer to data Picture data array */
} PicDef_t;
/**
 * @brief  picture structure
 */
extern PicDef_t Pic_chameleon;
